...
class TuzatishSorovi(Base):
    # Operator "Tugallanganlar" ro'yxatidagi mashina ma'lumotida xato
    # ko'rsa, uni O'ZI to'g'ridan-to'g'ri o'zgartira olmaydi - shu jadvalga
    # "tuzatish so'rovi" qoldiradi (holat="kutilmoqda"). Admin so'rovni
    # ko'rib chiqadi: TASDIQLASA hujjat (yoki namlik/ifloslik uchun uning
    # barcha o'lchov qatorlari) haqiqatan yangilanadi, RAD ETSA hujjat
    # o'zgarmaydi. Har bir so'rov AYNAN BITTA maydon uchun.

...
class ApiService {
  ...
  /// backend'ga "tuzatish so'rovi" yuboradi (admin tasdiqlaydi yoki rad
  /// etadi). Har bir so'rov AYNAN BITTA maydon uchun. Muvaffaqiyatli
  /// bo'lsa `null`, aks holda ko'rsatiladigan xato matnini qaytaradi.
